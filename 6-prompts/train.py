...
def reset_cfg(cfg, args):
    ...
    if args.dataset_var != "":
        if args.mix_distribution:
            cfg.MIX_DISTRIBUTION = True
            cfg.CROSS_DATASET = False
            print("Cross dataset is not supported yet!")
        else :
            cfg.MIX_DISTRIBUTION = False
            cfg.CROSS_DATASET = True
            print("Cross dataset is supported yet!")
        cfg.DATASET.NAME_VAR = args.dataset_var
...
def extend_cfg(cfg):
    ...
    cfg.DATASET.SUBSAMPLE_CLASSES ="all" # all, base or new
    # cfg.DATASET.SUBSAMPLE_CLASSES ="new4"
...
if __name__ == "__main__":
    ...
    # sub = 'new4'
    # DATASET = 'imagenet'
    # CFG = 'vit_b16_ep50_c4_BZ4_ProDA'  # rn50, rn101, vit_b32 or vit_b16
    # args.root = "your_data_path"
    # args.trainer = 'ProDA'
    # args.seed = 3
    # args.dataset_config_file = f"configs/datasets/{DATASET}.yaml"
    # args.config_file = f'configs/trainers/{args.trainer}/{CFG}.yaml'
    # args.output_dir =  f'output/base2new/test_{sub}/{DATASET}/{CFG}/seed{args.seed}'
    # args.model_dir = f'output/base2new/train_base/{DATASET}/{CFG}/seed{args.seed}'
    # args.load_epoch = 50
    # args.eval_only = True
